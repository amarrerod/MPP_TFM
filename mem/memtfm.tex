...
\HRule
\begin{flushright}
        {\Huge On the automatic planning of healthy and balanced menus} \\[2.5mm]
...
\bigskip
``{\it On the automatic planning of healthy and balanced menus.}''
...
\newpage{\pagestyle{empty}}
\chapter{Background}\label{ref:intro}
